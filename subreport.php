...
<script language="JavaScript">
  ...
  // }
    ...
    // var sub = new Date("Report.ddl.value").val().replace(/-/g,"/"));
	   if(Report.ddl.value < std){
	   	alert("The deadline you choose has passed!");
			return false;
	   }
...
<title>TEST Submit Report Page</title>	
<style type="text/css">
...
<form name="Report" form method="post" action="subrep.php" enctype="multipart/form-data" onsubmit="return Inputcheck(this)">  
<div id="prosettitle" style="position:absolute;top:140px;left:420px">
      <font face="Times New Roman"><font size=6><font color=#5e0e0e>Submit Report</font></font></font></br>
</div>
...
<li><font size=4><font color=#a9484e><font face="Times New Roman">Deadline:</font></font></font></br></li> <li><input name="ddl" type="date"/></li><font size=2><font color=#96343b>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp<u>Only before 20:00 on Deadline</u> of this report(usually Sunday) is legal</br>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp(e.g. 2017.10.29 is the deadline, then you should choose <u>exactly 2017.10.29</u>; 2017.10.28 or day before that would be illegal.</font></font>
</br></br>
<li><font size=4><font color=#a9484e><font face="Times New Roman">Report:</font></font></font></br></li> <li><input name="report" type="file"/></li><font size=2><font color=#96343b>&nbsp&nbsp&nbsp&nbsp&nbsp&nbspMax size:10M</font></font>
</br></br></br>
<font size=2><font face="Times New Roman">*You can upload again if you think the report needs modification, only the lastest version is counted, just remember to submit it before Sunday.</font></font></br></br>
