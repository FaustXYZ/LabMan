  ...
  // }
    ...
    // var std = getdate();
      ...
      // document.write(std);
        ...
        if(inven.number.value=="") {
            alert("Please input Qty");
            return false;
        }
        if(inven.storage.value=="") {
            alert("Please Choose the store site!");
            return false;
        }
        if(inven.action.value=="") {
...
<form name="inven" form method="post" action="inventory.php" enctype="multipart/form-data" onsubmit="return Inputcheck(this)">  
<div id="prosettitle" style="position:absolute;top:140px;left:420px">
      <font face="Times New Roman"><font size=6><font color=#00629b>Inventory</font></font></font></br>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp
...
</br><li><font size=3><font color=#00629b><font face="Times New Roman">Qty:</font></font></font></br></li>
<li><input name="number" type="text" style="width:70px" placeholder="e.g. 5"></li>
</br><li><font size=3><font color=#00629b><font face="Times New Roman">Storage:</font></font></font></br></li>
<li><select name="storage" style="width:120px">
  <option value=""></option>
    <?php
    include("connectDB.php");
    $result2=mysql_query("select distinct(store) as resto from think_reagent");
    include("disconnectDB");
while($rs=mysql_fetch_array($result2)){  
    ?>  
    <option value="<?php echo $rs['resto'];?>"><?php echo $rs['resto'];?></option>  
    <?php  
}  
?>  
</select></li>
</br><li><font size=3><font color=#00629b><font face="Times New Roman">Action:</font></font></font></br></li>
<li><select name="action" style="width:80px">
  <option value=""></option>
