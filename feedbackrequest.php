...
<script language="JavaScript">
  ...
  // }
	function Inputcheck(executestate){
		...
		// }
    // var std = getdate();
		if(executestate.oID.value=="" &&executestate.applyfeedback.value==""){
      // document.write(std);
			alert("Please enter OrderID or choose range");
			return false;
		}
		alert("If and Only if you got three positive response from three advisors, you can proceed to order reagents.")
...
<title>TEST check state page</title>	
<style type="text/css">
...
<form name="executestate" form method="post" action="requestexecute.php" enctype="multipart/form-data" onsubmit="return Inputcheck(this)">  
<div id="prosettitle" style="position:absolute;top:140px;left:420px">
      <font face="Times New Roman"><font size=6><font color=#00629b>Request state</font></font></font></br>
</div>
...
<li><font size=4><font color=#00629b><font face="Times New Roman">Check request state:</font></font></font></br></li>
<li><select name="applyfeedback" style="width:120px">
  <option value=""></option>
   <option value="last7day">Last 7 days</option>
   <option value="last2week">Last 2 weeks</option>
   <option value="last1month">Last 1 month</option>
   <option value="last3month">Last 3 months</option>
   <option value="all">All</option>
</select></li></br><font color=#00629b><i>&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbspOR</i></font></br></br>
<li><font size=4><font color=#00629b><font face="Times New Roman">Check by OrderID:</font></font></font></br></li> <li><input name="oID" type="text"/></li>
</br>

<font size=2><font face="Times New Roman">*Individuals with auth>2 can check requests regardless applicant,</br>&nbsp&nbspothers can only check ones submitted by yourself.</font></font></br>
</br>
